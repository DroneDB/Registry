...
public interface IDdbWrapper
{
    ...
    /// Paths are dataset-relative and are indexed exactly as given (never recursively: a
    /// recursive native walk would surface paths the caller never asked for and break the
